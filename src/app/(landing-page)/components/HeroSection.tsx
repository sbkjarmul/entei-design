...
export default function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center text-center py-20 gap-6">
      ...
      <Heading level={1}>
        Sprawimy, że Twoja firma będzie wyglądała lepiej, niż konkurencja
      </Heading>
      <Text>
        Wiemy jak tworzyć ponadczasowe logo oraz ultraszybkie strony
        internetowę, którę sprawiąją, że klienci od pierwszego kontaktu z Twoją
        firmą będą zachwyceni!
      </Text>
